...
export class Status extends StatusImpl {}

// Type for interface data only (excludes class methods from merged type)
export type StatusData = Omit<Status, 'serializeBinary' | 'toObject' | 'constructor'>;
...
// Export class alias without Impl suffix for Node.js compatibility
export class Status_Detail extends Status_DetailImpl {}

// Type for interface data only (excludes class methods from merged type)
export type Status_DetailData = Omit<Status_Detail, 'serializeBinary' | 'toObject' | 'constructor'>;

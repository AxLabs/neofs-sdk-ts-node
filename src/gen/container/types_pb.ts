...
import { NeoFsV2Netmap } from '../netmap/types_pb';
...
export class Container extends ContainerImpl {}

// Type for interface data only (excludes class methods from merged type)
export type ContainerData = Omit<Container, 'serializeBinary' | 'toObject' | 'constructor'>;
...
export class Container_AttributeImpl implements Container_Attribute {
  ...
  toObject(): Container_AttributeData {
    return {
      Key: this.Key,
      Value: this.Value
    };
...
// Export class alias without Impl suffix for Node.js compatibility
export class Container_Attribute extends Container_AttributeImpl {}

// Type for interface data only (excludes class methods from merged type)
export type Container_AttributeData = Omit<Container_Attribute, 'serializeBinary' | 'toObject' | 'constructor'>;

...
export class Link extends LinkImpl {}

// Type for interface data only (excludes class methods from merged type)
export type LinkData = Omit<Link, 'serializeBinary' | 'toObject' | 'constructor'>;
...
export class Link_MeasuredObjectImpl implements Link_MeasuredObject {
  ...
  toObject(): Link_MeasuredObjectData {
    return {
      Id: this.Id,
      Size: this.Size
    };
...
// Export class alias without Impl suffix for Node.js compatibility
export class Link_MeasuredObject extends Link_MeasuredObjectImpl {}

// Type for interface data only (excludes class methods from merged type)
export type Link_MeasuredObjectData = Omit<Link_MeasuredObject, 'serializeBinary' | 'toObject' | 'constructor'>;

...
export class StorageGroup extends StorageGroupImpl {}

// Type for interface data only (excludes class methods from merged type)
export type StorageGroupData = Omit<StorageGroup, 'serializeBinary' | 'toObject' | 'constructor'>;
